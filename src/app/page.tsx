...
import { HeroBackground } from "@/components/mhmw/HeroBackground";
...
export default function MyHouseMyWayPage() {
  return (
    <div className="flex min-h-screen w-full flex-col bg-mhmw-grey-10" data-node-id="2979:26811">
      <div className="relative isolate min-h-[640px] overflow-hidden pb-28 sm:min-h-[720px] sm:pb-36">
        <HeroBackground />
        <FloatingBadges />
        <div className="relative flex flex-col">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-16 sm:py-24">
            <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-6 text-center">
              <h1
                className="mhmw-animate-in font-mhmw-display text-[28px] leading-[1.2] font-black text-mhmw-bg-default sm:text-[31px] sm:leading-[37.2px]"
